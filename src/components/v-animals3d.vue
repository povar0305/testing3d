                ...
                <v-list-item three-line>
                    <v-list-item-content>
                        <div class="text-overline mb-4">
                            Как хорошо ты знаешь животных
                        </div>
                        <v-list-item-title class="text-h5 mb-1">
                            Выбери животное
                        </v-list-item-title>
                        <v-list-item-subtitle>Внимательно рассмотри животное и выбери внизу правильный
                ...
                <v-card-actions>
                    <v-row justify="center">
                        <v-col>
                            <v-sheet>
                                <div class="pa-4">
                                    <v-chip-group active-class="blue darken-1 white--text" column class="align-center">
                                        <v-chip class="blue lighten-4" v-for="answer in this.answers" :key="answer">
                                            {{ answer }}
                                        </v-chip>
                                    </v-chip-group>
                                </div>
...
export default {
    ...
    mounted() {
        ...
        const camera = new THREE.PerspectiveCamera(75, $('.scene').width() / $('.scene').height(), 1, 100);
